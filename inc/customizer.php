<?php 
	function wpb_customize_register($wp_customize) {
		...
		$wp_customize->add_section('showcase', array(
			'title'	=> __('Showcase', 'wpbootstrap'), 'description' => sprintf(__('Options for showcase', 'wpbootstrap')),
			'priority'	=> 130
		));
		...
		$wp_customize->add_setting('showcase_text', array(
			'default'	=> _x('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla id neque venenatis arcu commodo venenatis.', 'wpbootstrap'), 
			'type' 	=> 'theme_mod'
		));
